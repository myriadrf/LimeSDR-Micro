...
The LimeSDR Micro clock system is based on a high stability 30.72 MHz VCTCXO (Voltage Controlled Temperature Compensated Crystal Oscillator) which can be tuned via an external 1PPS reference signal or GPSDO function.
...
.. note::
   By default 1PPS input source is onboard GNSS receiver. To change 1PPS input source remove R176 and populate R173 (M.2) or R179 (MHF4 J5) with zero-ohm resistor.
