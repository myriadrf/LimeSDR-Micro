...
.. note::
   Only one TX channel (TX1) is connected to BB processor; the second LMS7002M TX channel (TX2) baseband pins are connected to 15-pin FPC connector (X8) described in :doc:`BB_CON`.
