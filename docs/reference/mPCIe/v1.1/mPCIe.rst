...
Connector pinout and signals according to the specification is given in Table 13.

.. list-table:: Table 13. Mini PCIe x1 edge connector pinout 
   :header-rows: 1
   :stub-columns: 1
   ...
   * - 2
     - 3.3 Vaux
     - VCC3P3_MPCIE
     - Main 3.3 V power input (VCC3P3_MPCIE)
   * - 3
     - COEX1
     - PCIE_PPS_IN
     - External 1PPS input
   ...
   * - 7
     - CLKREQ#
     - CLK_REQUEST#
     - PCIe clock request tied to GND through a 330 Ω resistor
   * - 8
     - UIM PWR
     - NC
     - Not connected
