...
via 0.3mm pitch 15 pin FPC connectors (X8 and X13). NXP base band processors RX observation external connector (X13) pinout is shown in Table 5. 
LMS7002M TX ADC connector (X8) pinout is shown in Table 6.


.. list-table:: Table 5. Basedand processors RX obeservation external BB 15-pin FPC connector (X13)
   :header-rows: 1
   :stub-columns: 1
...
.. list-table:: Table 6. LMS7002M TX BB ADC 15-pin FPC connector (X8)
   :header-rows: 1
   :stub-columns: 1
