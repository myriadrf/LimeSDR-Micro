...
.. note::
   Only one TX channel (TX1) is connected to BB processor; the second LMS7002M TX channel (TX2) baseband pins are connected to 15-pin FPC connector (X3) described in :doc:`BB_CON`.
...
.. table:: Table 2. LMS7002M RF transceiver signals
    ...
    +----------------------+----------------------------+-----------------------------+-----------------------+--------------------------+----------------------------------------------+
    | U29                  | TXEN                       | LMS_TXEN                    | M15                   | LNA1_EN                  | Transmitter enable/disable control           |
    +----------------------+----------------------------+-----------------------------+-----------------------+--------------------------+----------------------------------------------+
