...
* LMS_RXEN – receiver enable/disable signal is not controlled and connected to VDIO_LMS (3.3V) power rail.
* LMS_TXEN – transmitter enable/disable signal is connected to Baseband processors pin M15.
