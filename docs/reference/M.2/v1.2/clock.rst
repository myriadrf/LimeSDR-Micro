...
LimeSDR Micro M.2 2280 v1.2 board clock distribution block diagram is as shown in Figure 7.

.. figure:: /images/LimeSDR-Micro_M.2_v1.1_diagrams_r0_clock.png
  :width: 600

  Figure 7. LimeSDR Micro M.2 2280 v1.2 board clock distribution block diagram

LimeSDR Micro M.2 2280 v1.2 board features an on board 30.72 MHz VCTCXO as the reference clock for 
