...
LimeSDR Micro Micro M.2 2280 v1.0 board comes with two green indicator LEDs. These LEDs are soldered on the top of the board near RF shield (rigth edge). 

.. figure:: /images/LimeSDR-Micro_M.2_2280_v1.0_components_LEDs.png
  :width: 600

  Figure 8. LimeSDR Micro M.2 2280 v1.0 indication LEDs (top)
