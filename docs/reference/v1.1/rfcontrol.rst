...
.. table:: Table 4. RF network control signals
    ...
    +=============================+=============================+==================+=================+========================================================+
    | SKY13330-397LF(IC5)         | TX_SW/TX_SW_DIV             | 3.3V             | P15 (FPGA)      | 3.3V logic level   signal divided to 2.4V logic level. |
    +-----------------------------+-----------------------------+------------------+-----------------+--------------------------------------------------------+
    ...
    +-----------------------------+-----------------------------+------------------+-----------------+--------------------------------------------------------+
    | J2                          | LA_PA_EN                    | 3.3V             | P14 (FPGA)      | RF control signal output                               |
    +-----------------------------+-----------------------------+------------------+-----------------+--------------------------------------------------------+
    | X8                          | LA_TRX1                     | 3.3V             | P15 (FPGA)      | RF control signal output                               |
    |                             +-----------------------------+------------------+-----------------+                                                        |
    |                             | LA_PA_EN                    | 3.3V             | P14 (FPGA)      |                                                        |
    |                             +-----------------------------+------------------+-----------------+                                                        |
